...
extern size_t prg_rom_len;
extern const Byte chr_rom[];
extern size_t chr_rom_len;
...
static inline void ppu_catch_up(void) {
...
#define CHECK_PAGE_CROSS(base, effective)                                      \
  do {                                                                         \
...
#define ADDR_MODE_ABS_X_GET(to, operand, check_crossing)                       \
  do {                                                                         \
...
#define ADDR_MODE_ABS_Y_GET(to, operand, check_crossing)                       \
  do {                                                                         \
...
#define ADDR_MODE_IND_GET(to, operand, check_crossing)                         \
  do {                                                                         \
...
#define ADDR_MODE_IND_X_GET(to, operand, check_crossing)                       \
  do {                                                                         \
    Byte lo = cpu_read((operand + X) & 0xFF);                                  \
    Byte hi = cpu_read((operand + X + 1) & 0xFF);                              \
    to = cpu_read((lo + hi * 256) & 0xFFFF);                                   \
  } while (0)
#define ADDR_MODE_IND_Y_GET(to, operand, check_crossing)                       \
  do {                                                                         \
...
#define ADDR_MODE_IND_X_SET(operand, value)                                    \
  do {                                                                         \
    Byte lo = cpu_read((operand + X) & 0xFF);                                  \
    Byte hi = cpu_read((operand + X + 1) & 0xFF);                              \
    cpu_write((lo + hi * 256) & 0xFFFF, value);                                \
  } while (0)
#define ADDR_MODE_IND_Y_SET(operand, value)                                    \
  do {                                                                         \
    Byte lo = cpu_read((operand) & 0xFF);                                      \
    Byte hi = cpu_read((operand + 1) & 0xFF);                                  \
...
#define COMPARE(reg, mode, operand)                                            \
  do {                                                                         \
    Byte mem;                                                                  \
    ADDR_##mode##_GET(mem, operand, true);                                     \
